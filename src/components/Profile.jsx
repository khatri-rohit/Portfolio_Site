    ...
    return (
        <div className="p-3 bg-white dark:bg-[#222831] rounded-3xl drop-shadow-lg h-full duration-300">
            ...
            <div className="p-3 flex flex-col items-center">
                ...
                <p className="md:text-3xl lg:text-4xl text-2xl font-sans dark:text-[#F5F5F7] duration-300">
                    Hey👋🏻! My name is
                </p>
                <p className="name font-extrabold">
                    Rohit Khatri
                </p>
                <p className="md:text-3xl md:my-3 text-2xl my-0.5 leading-tight text-slate-700 text-left translate duration-300 text-pretty dark:text-[#F5F5F7]">
